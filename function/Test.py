...
from function.Show import show_predicted, create_dir, get_files_num, save_data, get_model_last_file_name, write_log_model
...
def predict():
    ...
    correct = 0
    total = 0
    create_dir(error_image_path)  # 创建保存预测错误图片的文件夹
