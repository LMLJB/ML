...
from utils.Show import show_train_loss
...
def train_model():
    ...
    model_number = len(os.listdir(model_and_log_path))
    ...
    for epoch in range(EPOCH):
        ...
        encapsulation(model.state_dict(), model_path + r'\model.pkl', epoch + 1)  # 调用测试函数对测试集测试
